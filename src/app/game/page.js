...
export default function Game() {
  ...
  return (
    <main className="flex w-full h-lvh flex-col items-center justify-center ">
      <div className="sm:w-1/3 w-full h-full relative flex flex-col justify-between bg-third ">  {/**column */}
        {statusGioco ? (
